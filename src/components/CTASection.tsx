        ...
        <div className="bg-gradient-to-r from-purple-600/30 to-pink-600/30 rounded-3xl p-12 border border-white/20 backdrop-blur-sm text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="text-center">
              <div className="text-2xl font-bold text-white mb-2">Local Pricing</div>
              <div className="text-gray-300">Affordable monthly plans</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-white mb-2">Quick Setup</div>
              <div className="text-gray-300">15-minute integration</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-white mb-2">Local Support</div>
              <div className="text-gray-300">From people who understand your area</div>
            </div>
          </div>
        </div>
        
        <footer className="mt-20 text-center text-gray-400">
          <p>&copy; 2024 LocalEdgeAI. Bringing advanced AI solutions to local businesses everywhere.</p>
        </footer>
      </div>
    </section>
  );
